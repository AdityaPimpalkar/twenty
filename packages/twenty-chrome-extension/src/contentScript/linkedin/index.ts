import { insertButtonForCompany } from '~/contentScript/linkedin/company/extractCompanyProfile';
import { insertButtonForPerson } from '~/contentScript/linkedin/person/extractPersonProfile';
